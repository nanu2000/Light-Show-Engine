...
)
{
	...
	float widthCalculated =
		spriteOrientationInPixels.z / texture.getWidth();
	
	float heightCalculated =
		spriteOrientationInPixels.w / texture.getHeight();

	float xPositionCalculated =
		spriteOrientationInPixels.x / texture.getWidth();
	
	float yPositionCalculated =
		spriteOrientationInPixels.y / texture.getHeight();
